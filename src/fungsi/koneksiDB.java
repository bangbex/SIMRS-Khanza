...
//                                +
            ...
            if (loginAttempt >= 3) {
                ...
                JOptionPane.showMessageDialog(null,
                        "Koneksi Gagal (Percobaan " + loginAttempt + "/3). Periksa Jaringan/Database.");
            }
        }
        return connection;
    }
    ...
    public static String URLAPIMEDQLAB() {
        return getVal("URLAPIMEDQLAB", false);
    }

    public static String SECRETKEYAPIMEDQLAB() {
        return getVal("SECRETKEYAPIMEDQLAB", true);
    }

    public static String CONSIDAPIMEDQLAB() {
        return getVal("CONSIDAPIMEDQLAB", true);
    }

    // Carestream & Softmedix
    public static String URLCARESTREAM() {
        return getVal("URLCARESTREAM", false);
    }

    public static String URLAPISOFTMEDIX() {
        return getVal("URLAPISOFTMEDIX", false);
    }

    public static String PRODUCTSOFTMEDIX() {
        return getVal("PRODUCTSOFTMEDIX", true);
    }

    public static String VERSIONSOFTMEDIX() {
        return getVal("VERSIONSOFTMEDIX", true);
    }

    public static String USERIDSOFTMEDIX() {
        return getVal("USERIDSOFTMEDIX", true);
    }

    public static String KEYSOFTMEDIX() {
        return getVal("KEYSOFTMEDIX", true);
    }

    // Resep & BPJS Logic
    public static String RESEPRAJALKEPLAN() {
        return getVal("RESEPRAJALKEPLAN", false);
    }

    public static String DIAGNOSARUJUKANMASUKAPIBPJS() {
        return getVal("DIAGNOSARUJUKANMASUKAPIBPJS", false);
    }

    // UI/Tampilan
    public static String AKTIFKANWARNARALAN() {
        return getVal("AKTIFKANWARNARALAN", false);
    }

    // API SATUSEHAT (Kredensial Terenkripsi)
    public static String CLIENTIDSATUSEHAT() {
        return getVal("CLIENTIDSATUSEHAT", true);
    }

    public static String SECRETKEYSATUSEHAT() {
        return getVal("SECRETKEYSATUSEHAT", true);
    }

    public static String IDSATUSEHAT() {
        return getVal("IDSATUSEHAT", true);
    }

    // API SATUSEHAT (Endpoints & Wilayah)
    public static String URLAUTHSATUSEHAT() {
        return getVal("URLAUTHSATUSEHAT", false);
    }

    public static String URLFHIRSATUSEHAT() {
        return getVal("URLFHIRSATUSEHAT", false);
    }

    public static String KELURAHANSATUSEHAT() {
        return getVal("KELURAHANSATUSEHAT", false);
    }

    public static String KECAMATANSATUSEHAT() {
        return getVal("KECAMATANSATUSEHAT", false);
    }

    public static String KABUPATENSATUSEHAT() {
        return getVal("KABUPATENSATUSEHAT", false);
    }

    public static String PROPINSISATUSEHAT() {
        return getVal("PROPINSISATUSEHAT", false);
    }

    public static String KODEPOSSATUSEHAT() {
        return getVal("KODEPOSSATUSEHAT", false);
    }

    // API ESIGN
    public static String URLAPIESIGN() {
        return getVal("URLAPIESIGN", false);
    }

    public static String USERNAMEAPIESIGN() {
        return getVal("USERNAMEAPIESIGN", true);
    }

    public static String PASSAPIESIGN() {
        return getVal("PASSAPIESIGN", true);
    }

    public static String URLAKSESFILEESIGN() {
        return getVal("URLAKSESFILEESIGN", false);
    }

    public static String SFTPFILEESIGNHOST() {
        return getVal("SFTPFILEESIGNHOST", true);
    }

    public static String SFTPFILEESIGNPORT() {
        return getVal("SFTPFILEESIGNPORT", true);
    }

    public static String SFTPFILEESIGNUSER() {
        return getVal("SFTPFILEESIGNUSER", true);
    }

    public static String SFTPFILEESIGNPAS() {
        return getVal("SFTPFILEESIGNPAS", true);
    }

    public static String SFTPFILEESIGNFOLDER() {
        return getVal("SFTPFILEESIGNFOLDER", true);
    }

    // API SERTISIGN
    public static String URLAPISERTISIGN() {
        return getVal("URLAPISERTISIGN", false);
    }

    public static String APIKEYSERTISIGN() {
        return getVal("APIKEYSERTISIGN", true);
    }

    public static String URLDOKUMENSERTISIGN() {
        return getVal("URLDOKUMENSERTISIGN", false);
    }

    // API DUTAPARKING
    public static String HOSTDUTAPARKING() {
        return getVal("HOSTDUTAPARKING", true);
    }

    public static String DATABASEDUTAPARKING() {
        return getVal("DATABASEDUTAPARKING", true);
    }

    public static String PORTDUTAPARKING() {
        return getVal("PORTDUTAPARKING", true);
    }

    public static String USERDUTAPARKING() {
        return getVal("USERDUTAPARKING", true);
    }

    public static String PASDUTAPARKING() {
        return getVal("PASDUTAPARKING", true);
    }

    // API ICARE
    public static String URLAPIICARE() {
        return getVal("URLAPIICARE", false);
    }

    public static String SECRETKEYAPIICARE() {
        return getVal("SECRETKEYAPIICARE", true);
    }

    public static String CONSIDAPIICARE() {
        return getVal("CONSIDAPIICARE", true);
    }

    public static String USERKEYAPIICARE() {
        return getVal("USERKEYAPIICARE", true);
    }

     public static String URLAPISMARTCLAIM(){
        return getVal("URLAPISMARTCLAIM", false);
    }
    
    // API SmartClaim 
    public static String SECRETKEYAPISMARTCLAIM() {
        return getVal("SECRETKEYAPISMARTCLAIM", true);
    }
    public static String CONSIDAPISMARTCLAIM() {
        return getVal("CONSIDAPISMARTCLAIM", true);
    }
    public static String USERKEYAPISMARTCLAIM() {
        return getVal("USERKEYAPISMARTCLAIM", true);
    }
    
    // Antrian
    public static String LOKETANTRIAN() {
        return getVal("LOKETANTRIAN", false);
    }

    // Resep
    public static String TAMPILKANCOPYRESEPDOKTERLAIN() {
        return getVal("TAMPILKANCOPYRESEPDOKTERLAIN", false);
    }

    public static String AKTIFKANRESEPITERDOKTER() {
        return getVal("AKTIFKANRESEPITERDOKTER", false);
    }

    // BPJS tambahan
    public static String JADIKANBOOKINGSURATKONTROL() {
        return getVal("JADIKANBOOKINGSURATKONTROL", false);
    }

    public static String JADIKANBOOKINGSURATKONTROLAPIBPJS() {
        return getVal("JADIKANBOOKINGSURATKONTROLAPIBPJS", false);
    }

    public static String ADDANTRIANAPIMOBILEJKN() {
        return getVal("ADDANTRIANAPIMOBILEJKN", false);
    }

    public static String KODEPPKAPOTEKBPJS() {
        return getVal("KODEPPKAPOTEKBPJS", true);
    }

    // Database FUJI
    public static String HOSTFUJI() {
        return getVal("HOSTFUJI", true);
    }

    public static String DATABASEFUJI() {
        return getVal("DATABASEFUJI", true);
    }

    public static String PORTFUJI() {
        return getVal("PORTFUJI", true);
    }

    public static String USERFUJI() {
        return getVal("USERFUJI", true);
    }

    public static String PASFUJI() {
        return getVal("PASFUJI", true);
    }

    // Database SYSMEX
    public static String HOSTSYSMEX() {
        return getVal("HOSTSYSMEX", true);
    }

    public static String DATABASESYSMEX() {
        return getVal("DATABASESYSMEX", true);
    }

    public static String PORTSYSMEX() {
        return getVal("PORTSYSMEX", true);
    }

    public static String USERSYSMEX() {
        return getVal("USERSYSMEX", true);
    }

    public static String PASSYSMEX() {
        return getVal("PASSYSMEX", true);
    }

    // Database ELIMS
    public static String HOSTELIMS() {
        return getVal("HOSTELIMS", true);
    }

    public static String DATABASEELIMS() {
        return getVal("DATABASEELIMS", true);
    }

    public static String PORTELIMS() {
        return getVal("PORTELIMS", true);
    }

    public static String USERELIMS() {
        return getVal("USERELIMS", true);
    }

    public static String PASELIMS() {
        return getVal("PASELIMS", true);
    }

    // Database SMARTLAB
    public static String HOSTSMARTLAB() {
        return getVal("HOSTSMARTLAB", true);
    }

    public static String DATABASESMARTLAB() {
        return getVal("DATABASESMARTLAB", true);
    }

    public static String PORTSMARTLAB() {
        return getVal("PORTSMARTLAB", true);
    }

    public static String USERSMARTLAB() {
        return getVal("USERSMARTLAB", true);
    }

    public static String PASSMARTLAB() {
        return getVal("PASSMARTLAB", true);
    }

    // Database VANSLAB
    public static String HOSTVANSLAB() {
        return getVal("HOSTVANSLAB", true);
    }

    public static String DATABASEVANSLAB() {
        return getVal("DATABASEVANSLAB", true);
    }

    public static String PORTVANSLAB() {
        return getVal("PORTVANSLAB", true);
    }

    public static String USERVANSLAB() {
        return getVal("USERVANSLAB", true);
    }

    public static String PASVANSLAB() {
        return getVal("PASVANSLAB", true);
    }

    // Database SLIMS
    public static String HOSTSLIMS() {
        return getVal("HOSTSLIMS", true);
    }

    public static String DATABASESLIMS() {
        return getVal("DATABASESLIMS", true);
    }

    public static String PORTSLIMS() {
        return getVal("PORTSLIMS", true);
    }

    public static String USERSLIMS() {
        return getVal("USERSLIMS", true);
    }

    public static String PASSLIMS() {
        return getVal("PASSLIMS", true);
    }

    // ORTHANC
    public static String URLORTHANC() {
        return getVal("URLORTHANC", false);
    }

    public static String PORTORTHANC() {
        return getVal("PORTORTHANC", true);
    }

    public static String USERORTHANC() {
        return getVal("USERORTHANC", true);
    }

    public static String PASSORTHANC() {
        return getVal("PASSORTHANC", true);
    }

    // SFTP MANDIRI
    public static String SFTPMANDIRIPATHPEMBAYARANPIHAKKETIGA() {
        return getVal("SFTPMANDIRIPATHPEMBAYARANPIHAKKETIGA", true);
    }

    public static String SFTPMANDIRIPATHPEMBAYARANPAJAK() {
        return getVal("SFTPMANDIRIPATHPEMBAYARANPAJAK", true);
    }

    public static String SFTPMANDIRIPATHPEMBAYARANVIRTUALACCOUNT() {
        return getVal("SFTPMANDIRIPATHPEMBAYARANVIRTUALACCOUNT", true);
    }

    public static String SFTPMANDIRIPATHACK() {
        return getVal("SFTPMANDIRIPATHACK", true);
    }

    public static String SFTPMANDIRIPATHMT940() {
        return getVal("SFTPMANDIRIPATHMT940", true);
    }

    public static String SFTPMANDIRIHOST() {
        return getVal("SFTPMANDIRIHOST", true);
    }

    public static String SFTPMANDIRIPORT() {
        return getVal("SFTPMANDIRIPORT", true);
    }

    public static String SFTPMANDIRIUSER() {
        return getVal("SFTPMANDIRIUSER", true);
    }

    public static String SFTPMANDIRIPAS() {
        return getVal("SFTPMANDIRIPAS", true);
    }
